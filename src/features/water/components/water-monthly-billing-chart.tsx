...
function makeValueLabelsPlugin(displayCurrency: string | null): Plugin<'bar'> {
  return {
    id: 'waterMonthlyBillingValueLabels',
...
interface WaterMonthlyBillingChartProps {
...
function getShortLabel(cycle: WaterBillingCycleItem): string {
...
export function WaterMonthlyBillingChart({
  cycles,
  amounts,
  displayCurrency,
  selectedCycleId,
