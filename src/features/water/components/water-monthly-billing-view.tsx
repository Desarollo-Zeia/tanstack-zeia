...
import { useWaterMonthlyBilling } from '../hooks/use-water-monthly-billing'
import { WaterMonthlyBillingChart } from './water-monthly-billing-chart'
import { WaterMonthlyBillingDetail } from './water-monthly-billing-detail'
import { WaterMonthlyBillingHero } from './water-monthly-billing-hero'

interface WaterMonthlyBillingViewProps {
  sedeId: number
}
...
export function WaterMonthlyBillingView({ sedeId }: WaterMonthlyBillingViewProps) {
  const {
    cycles,
    calculates,
    totalsByCycleId,
