...
export function useWaterTarifarioFilters() {
  const navigate = useNavigate({ from: '/energia/water/dashboard/tarifario' })
  const search = useSearch({ from: '/energia/water/dashboard/tarifario' })
